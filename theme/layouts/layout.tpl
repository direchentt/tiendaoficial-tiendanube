...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/" lang="{% for language in languages %}{% if language.active %}{{ language.lang }}{% endif %}{% endfor %}">
    <head>
        ...
        <meta name="hache-cart-url" content="{{ store.cart_url|e('html_attr') }}" />
    ...
    <body class="{% include 'snipplets/theme-brand-body-class.tpl' %} brand-grid-{{ settings.brand_grid_density | default('editorial') }} brand-card-{{ settings.brand_product_card_ratio | default('standard') }} {% if customer %}customer-logged-in{% endif %} template-{{ template | replace('.', '-') }}">
